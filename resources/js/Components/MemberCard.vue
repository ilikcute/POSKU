...
const generateQRCode = async () => {
    try {
        const dataUrl = await QRCode.toDataURL(props.member.member_code, {
            width: 80,
            margin: 1,
            color: {
                dark: '#000000',
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Preview Kartu Member</h3>
                    ...
                    <!-- Kartu Member -->
                    <div id="member-card" class="member-card-container">
                        <!-- Front Card -->
                        <div class="member-card front-card">
                            <!-- Background Pattern -->
                            ...
                            <div class="member-info">
                                ...
                                <div class="member-details">
                                    ...
                                    <div class="member-code-label">Kode Member:</div>
