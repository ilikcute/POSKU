            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-[#555] mt-1">
                        Kelola transaksi retur penjualan.
                    </p>
                </div>
...
const applyFilters = () => {
    router.get(route("sales-returns.index"), filters.value, {
        preserveState: true,
        replace: true,
    });
};
