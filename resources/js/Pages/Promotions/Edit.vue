    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="font-semibold text-lg text-[#1f1f1f] leading-tight">Edit Promosi</h2>
                    <p class="text-xs text-[#555] mt-1">Edit detail promosi dan pengaturannya.</p>
                </div>
                <div>
            ...
            <form @submit.prevent="submit"
                ...
                <div class="space-y-6">
                    ...
                    <div v-if="isBundling" class="space-y-4">
                        <div class="flex items-center justify-between">
                            <h3 class="text-sm font-semibold text-[#1f1f1f]">Bundling Rules</h3>
                        ...
                        <div v-for="(bundle, index) in form.bundles" :key="index"
                            ...
                            <div>
                                <label class="block text-xs font-medium text-[#1f1f1f] mb-2">Gratis Produk</label>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-[#1f1f1f] mb-2">Qty Gratis</label>
