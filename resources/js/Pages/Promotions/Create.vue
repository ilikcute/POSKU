    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="font-semibold text-xl text-white leading-tight">Buat Promosi Baru</h2>
                    <p class="text-sm text-gray-400 mt-1">Buat promosi baru dengan berbagai jenis dan pengaturan.</p>
                </div>
                <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="submit" :disabled="form.processing"
                            class="bg-gradient-to-r from-green-400 to-emerald-400 text-white font-bold py-3 px-6 rounded-lg hover:from-green-500 hover:to-emerald-500 transition disabled:opacity-50">
