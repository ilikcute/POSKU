    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="lg:hidden overflow-x-auto">
                            <table class="min-w-full text-xs text-gray-200">
                                <thead
                                    class="bg-gradient-to-r from-purple-600/30 to-blue-600/30 backdrop-blur-sm border-b border-white/20">
                                    <tr>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Kategori</th>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-700/50">
                                    <tr v-for="category in categories.data" :key="category.id" class="hover:bg-white/5">
                                        <td class="px-3 py-3">
                                            <div class="font-semibold text-white text-sm">{{ category.name }}</div>
                                        </td>
                                        <td class="px-3 py-3">
            ...
            <div v-else class="text-center py-12 backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl">
                ...
                <h3 class="text-lg font-medium text-gray-300 mb-2">Belum ada kategori</h3>
                <p class="text-gray-400">Tambah kategori baru untuk mengorganisir produk Anda.</p>
            </div>
