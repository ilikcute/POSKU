                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-sm font-bold text-gray-700 uppercase tracking-wide" style="font-family: 'Poppins', sans-serif;">Kode Customer</th>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-bold text-gray-700 uppercase tracking-wide" style="font-family: 'Poppins', sans-serif;">Alamat</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="customer in customers.data" :key="customer.id" class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap font-mono text-sm">{{ customer.member_code }}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap truncate max-w-xs text-gray-500" :title="customer.address">{{ customer.address || '-' }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button title="Cetak Kartu Customer" @click="printCard(customer)" class="inline-flex items-center px-2 py-1 border border-gray-300 text-xs font-medium rounded text-green-600 bg-white hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                        ...
                                        <button @click="openModal(true, customer)" class="inline-flex items-center px-2 py-1 border border-gray-300 text-xs font-medium rounded text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr v-if="customers.data.length === 0">
                                <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-lg font-medium text-gray-900">Belum ada data customer</p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
        ...
        <Modal :show="isModalOpen" @close="closeModal">
            <div class="p-6">
                ...
                <form @submit.prevent="saveItem" class="mt-6 space-y-4">
                    <div>
                        <InputLabel for="member_code" value="Kode Customer" />
                        <TextInput 
                            id="member_code" 
                            ...
                            required 
                        />
                        <InputError :message="form.errors.member_code" class="mt-2" />
                    </div>
                    <div>
                        <InputLabel for="name" value="Nama Customer" />
                        <TextInput 
                            id="name" 
                            v-model="form.name" 
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        <button type="button" @click="closeModal"
                            ...
                            <button
                                class="ms-3 inline-flex items-center px-2 py-1 border border-indigo-300 text-xs font-medium rounded text-indigo-600 bg-white hover:bg-indigo-50"
