        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="flex flex-wrap gap-3 justify-end">
                    ...
                    <Link :href="route('master.products.export')" class="inline-flex">
                        <button
                    ...
                    <div class="hidden lg:block overflow-x-auto">
                        <table class="min-w-full text-sm text-gray-200">
                            <thead class="bg-gradient-to-r from-purple-600/30 to-blue-600/30 backdrop-blur-sm border-b border-white/20">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Kode</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Nama Produk</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Kategori</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Divisi</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Rak</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Harga Beli</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Harga Jual</th>
                                    <th class="px-6 py-4 text-left text-xs uppercase tracking-wider font-semibold text-white/90">Stok</th>
                                    <th class="px-6 py-4 text-right text-xs uppercase tracking-wider font-semibold text-white/90">Aksi</th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="divide-y divide-gray-700/50">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-emerald-400 font-medium">{{ formatCurrency(product.purchase_price) }}</td>
                                    <td class="px-6 py-4 text-blue-400 font-medium">{{ formatCurrency(product.selling_price) }}</td>
                                    <td class="px-6 py-4">
                                        <span :class="getStockStatusClass(product.stock, product.min_stock_alert)" class="font-semibold">
                                            {{ product.stock ?? '-' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                        ...
                        <table class="min-w-full text-xs text-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-700/50">
                                ...
                                >
                                    ...
                                    <td class="px-3 py-3 text-[11px] text-blue-400 font-semibold">{{ formatCurrency(product.selling_price) }}</td>
                ...
                >
                    ...
                    >
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="inline-flex px-3 py-1 rounded-full text-xs font-medium border border-white/20 bg-white/10 text-gray-200">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="text-emerald-400 font-medium">{{ formatCurrency(product.purchase_price) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-300">Harga Jual</span>
                                <span class="text-blue-400 font-medium">{{ formatCurrency(product.selling_price) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-300">Harga Member</span>
                                <span class="text-purple-300 font-medium">{{ formatCurrency(product.member_price) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
