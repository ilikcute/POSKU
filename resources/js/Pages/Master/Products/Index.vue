<template>  
    ...
    <AuthenticatedLayout>
                    ...
                    <table class="min-w-full text-sm text-gray-200 divide-y divide-gray-600">
                        <thead class="bg-gray-800/70">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider">Nama Produk</th>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider">Harga Beli</th>
                                <th class="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider">Harga Jual</th>
                        ...
                        <tbody class="divide-y divide-gray-700">
                            ...
                            >
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">{{ formatCurrency(product.purchase_price) }}</td>
                                <td class="px-4 py-3 whitespace-nowrap">{{ formatCurrency(product.selling_price) }}</td>
                                <td class="px-4 py-3 whitespace-nowrap">{{ product.stock }}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button @click="openModal(true, product)" class="inline-block bg-gradient-to-r from-blue-400 to-blue-500 text-white font-bold py-2 px-4 rounded-full text-xs shadow-lg hover:scale-105 hover:from-blue-500 hover:to-blue-600 transition-transform duration-200">
                                            <svg class="w-3 h-3 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                            Edit
                                        </button>
                                        <button @click="deleteProduct(product.id)" class="inline-block bg-gradient-to-r from-red-400 to-red-500 text-white font-bold py-2 px-4 rounded-full text-xs shadow-lg hover:scale-105 hover:from-red-500 hover:to-red-600 transition-transform duration-200">
                                            <svg class="w-3 h-3 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr v-if="products.data.length === 0">
                                <td colspan="9" class="px-6 py-12 text-center text-gray-400">
                                    <div class="flex flex-col items-center">
                                        <svg class="w-12 h-12 text-gray-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
        ...
        <Modal :show="isModalOpen" @close="closeModal">
            <div class="p-8 bg-gray-900/70 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg max-w-4xl mx-auto space-y-6 text-white">
                ...
                <form @submit.prevent="saveProduct" class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <TextInput id="product_code" v-model="form.product_code" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" required />
                    ...
                    <div class="md:col-span-1">
                        ...
                        <TextInput id="barcode" v-model="form.barcode" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                        <InputError :message="form.errors.barcode" class="mt-2 text-red-400" />
                    </div>
                    <div class="md:col-span-1">
                        <InputLabel for="name" value="Nama Produk" class="text-gray-300"/>
                        <TextInput id="name" v-model="form.name" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" required />
                    ...
                    <div class="md:col-span-3">
                        ...
                        <TextInput id="description" v-model="form.description" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div>
                        ...
                        <select id="category_id" v-model="form.category_id" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="division_id" v-model="form.division_id" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="rack_id" v-model="form.rack_id" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="supplier_id" v-model="form.supplier_id" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select id="unit" v-model="form.unit" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <TextInput id="purchase_price" type="number" v-model="form.purchase_price" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" required />
                    ...
                    <div>
                        ...
                        <TextInput id="selling_price" type="number" v-model="form.selling_price" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" required />
                    ...
                    <div>
                        ...
                        <TextInput id="member_price" type="number" v-model="form.member_price" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div>
                        ...
                        <TextInput id="vip_price" type="number" v-model="form.vip_price" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div>
                        ...
                        <TextInput id="wholesale_price" type="number" v-model="form.wholesale_price" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div>
                        ...
                        <TextInput id="min_wholesale_qty" type="number" v-model="form.min_wholesale_qty" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div>
                        ...
                        <TextInput id="stock" type="number" v-model="form.stock" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                     ...
                     <div>
                        ...
                        <TextInput id="min_stock_alert" type="number" v-model="form.min_stock_alert" class="mt-1 block w-full bg-white/5 border-white/20 rounded-lg text-gray-200 focus:ring-blue-500 focus:border-blue-500" />
                    ...
                    <div class="md:col-span-3 flex justify-end gap-3 mt-4">
                        <button type="button" @click="closeModal" class="inline-block bg-gradient-to-r from-gray-500 to-gray-600 text-white font-bold py-2 px-6 rounded-full text-sm shadow-lg hover:scale-105 hover:from-gray-600 hover:to-gray-700 transition-transform duration-200">
                            <svg class="w-3 h-3 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                            </svg>
                            Batal
                        </button>
                        <button type="submit" :disabled="form.processing" class="inline-block bg-gradient-to-r from-green-400 to-emerald-400 text-white font-bold py-2 px-6 rounded-full text-sm shadow-lg hover:scale-105 hover:from-green-500 hover:to-emerald-500 transition-transform duration-200" :class="{ 'opacity-25': form.processing }">
                            <svg class="w-3 h-3 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
