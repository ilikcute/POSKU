    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="lg:hidden overflow-x-auto">
                            <table class="min-w-full text-xs text-gray-200">
                                <thead
                                    class="bg-gradient-to-r from-purple-600/30 to-blue-600/30 backdrop-blur-sm border-b border-white/20">
                                    <tr>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Supplier</th>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-700/50">
                                    <tr v-for="supplier in suppliers.data" :key="supplier.id" class="hover:bg-white/5">
                                        <td class="px-3 py-3">
                                            <div class="font-semibold text-white text-sm">{{ supplier.name }}</div>
                                        </td>
                                        <td class="px-3 py-3">
                            ...
                            <div v-for="supplier in suppliers.data" :key="supplier.id"
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-white">{{ supplier.name }}</h3>
                                        </div>
                                    </div>
                                </div>
            ...
            <div v-else class="text-center py-12 backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl">
                ...
                <h3 class="text-lg font-medium text-gray-300 mb-2">Belum ada supplier</h3>
                <p class="text-gray-400">Tambah supplier baru untuk mengorganisir produk Anda.</p>
            </div>
