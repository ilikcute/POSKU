<template>
    <AuthenticatedLayout>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1">
                        Kelola divisi dengan tampilan konsisten dan mudah.
                    </p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="divisions.data.length">
                <div class="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl shadow-xl overflow-hidden">
                        ...
                        <div class="hidden lg:block overflow-x-auto">
                            <table class="min-w-full text-sm text-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-700/50">
                                    <tr v-for="divisi in divisions.data" :key="divisi.id"
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    ...
                                                    {{ divisi.name.charAt(0).toUpperCase() }}
                                                </div>
                                                <div>
                                                    <p class="font-semibold text-white">{{ divisi.name }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex justify-end gap-2">
                                                <button @click="openModal(true, divisi)"
                                                ...
                                                <button @click="deleteDivision(divisi.id)"
                        ...
                        <div class="lg:hidden overflow-x-auto">
                            <table class="min-w-full text-xs text-gray-200">
                                <thead
                                    class="bg-gradient-to-r from-purple-600/30 to-blue-600/30 backdrop-blur-sm border-b border-white/20">
                                    <tr>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Divisi</th>
                                        <th class="px-3 py-3 text-left font-semibold text-white/90">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-700/50">
                                    <tr v-for="divisi in divisions.data" :key="divisi.id" class="hover:bg-white/5">
                                        <td class="px-3 py-3">
                                            <div class="font-semibold text-white text-sm">{{ divisi.name }}</div>
                                        </td>
                                        <td class="px-3 py-3">
                    ...
                    <div v-else>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                            <div v-for="divisi in divisions.data" :key="divisi.id"
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-white">{{ divisi.name }}</h3>
                                        </div>
                                    </div>
                                </div>
            ...
            <div v-else class="text-center py-12 backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl">
                ...
                <h3 class="text-lg font-medium text-gray-300 mb-2">Belum ada divisi</h3>
                <p class="text-gray-400">Tambah divisi baru untuk mengorganisir produk Anda.</p>
            </div>

            <Pagination v-if="divisions.links" :links="divisions.links" />
        </div>
