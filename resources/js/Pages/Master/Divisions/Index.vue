...
const deleteItem = (id) => {
    if (confirm("Apakah Anda yakin ingin menghapus item ini?")) {
        router.delete(route("master.divisions.destroy", id));
    }
};
</script>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-sm font-bold text-gray-700 uppercase tracking-wide" style="font-family: 'Poppins', sans-serif;">Nama Divisi</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="divisi in divisions.data" :key="divisi.id" class="hover:bg-gray-50">
