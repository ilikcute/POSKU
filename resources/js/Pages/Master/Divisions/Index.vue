    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                    ...
                                    <tr v-for="divisi in divisions.data" :key="divisi.id"
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="font-semibold text-[#1f1f1f]">{{ divisi.name }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                        ...
                        <div class="lg:hidden overflow-x-auto">
                            <table class="min-w-full text-xs text-[#1f1f1f]">
                                <thead
                                    class="bg-[#efefef] border-b border-[#9c9c9c]">
                                    <tr>
                                        <th class="px-3 py-3 text-left font-semibold text-[#1f1f1f]">Divisi</th>
                                        <th class="px-3 py-3 text-left font-semibold text-[#1f1f1f]">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-[#d0d0d0]">
                                    <tr v-for="divisi in divisions.data" :key="divisi.id" class="hover:bg-white">
                                        <td class="px-3 py-3">
                                            <div class="font-semibold text-[#1f1f1f] text-xs">{{ divisi.name }}</div>
                                        </td>
                                        <td class="px-3 py-3">
                            ...
                            <div v-for="divisi in divisions.data" :key="divisi.id"
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-[#1f1f1f]">{{ divisi.name }}</h3>
                                        </div>
                                    </div>
                                </div>
            ...
            <div v-else class="text-center py-12 bg-[#f7f7f7] border border-[#9c9c9c] rounded">
                ...
                <h3 class="text-sm font-semibold text-[#555] mb-2">Belum ada divisi</h3>
                <p class="text-[#555]">Tambah divisi baru untuk mengorganisir produk Anda.</p>
            </div>
        ...
        <Modal :show="isModalOpen" @close="closeModal">
            <div
                ...
                <form @submit.prevent="saveDivision" class="mt-6 grid grid-cols-1 gap-6">
                    <div>
                        <InputLabel for="name" value="Nama Divisi" class="text-[#555]" />
