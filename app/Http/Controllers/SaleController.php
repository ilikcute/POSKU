...
class SaleController extends Controller
{
    ...
    {
        $query = Sale::with(['user', 'store', 'customer', 'saleDetails.product'])
    ...
    public function create()
    {
        try {
            ...
            \Log::error('Error in SaleController::create', ['message' => $e->getMessage()]);
            return redirect()->route('dashboard')->with('error', 'Gagal memuat halaman penjualan.');
        }
    }
    ...
    {
        $sale->load(['user', 'store', 'customer', 'saleDetails.product', 'salesReturns']);
    ...
    {
        $sale->load(['user', 'store', 'customer', 'saleDetails.product']);
