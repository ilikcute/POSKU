...
Route::middleware('shift_required')->group(function () {
    ...
    Route::middleware('check.permission:view_stock')->group(function () {
        ...
        Route::get('stock-entries', [StockController::class, 'entries'])->name('stock-entries.index');
        Route::get('stock-adjustments', [StockController::class, 'adjustments'])->name('stock-adjustments.index');
        Route::get('stock-opnames', [StockController::class, 'opnames'])->name('stock-opnames.index');  // Jika butuh separate dari opname
    });
